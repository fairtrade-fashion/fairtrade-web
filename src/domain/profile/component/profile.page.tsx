...
//   if (isLoading) {
//     return <p>Loading...</p>; // Display a loading state while fetching profile
//   }

//   if (!userProfile) {
//     return <p>No user profile found.</p>; // Handle the case where no user profile is available
//   }
...
//             <img
//               src={userProfile.profilePicture || "/default-profile.png"} // Use the user's profile picture or a default image
//               alt="Profile"
