    ...
    <section className="bg-gray-50">
      ...
      <div className="items-center justify-center text-center">
        <Link to={"/category/jeans"}>
          <button className="px-5 py-3 font-semibold rounded-lg text-xl border-[3px] border-gray-800 hover:bg-gray-800 hover:text-white text-gray-800 bg-gradient-to-r from-white via-white to-white bg-[size:_100%] hover:from-gray-600 hover:to-black hover:bg-[position:_100%_100%] transition-all duration-500">
            View More
          </button>
        </Link>
      </div>
